...
// Barre de recherche avec autocompletion (debounce) sur l'API TheMealDB.
// Les suggestions sont regroupees en deux listes ("commence par" / "contient"),
// avec navigation au clavier (fleches, Entree, Echap) et selection a la souris.
